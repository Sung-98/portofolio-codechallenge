      ...
      <div className="container">
        <div className="w-full px-4">
          <div className="max-w-xl mx-auto text-center mb-16">
            <h4 className="font-semibold text-lg text-primary font-serif italic mb-2">
              Contact
            </h4>
        ...
        <form>
          <div className="w-full lg:w-2/3 lg:mx-auto">
            ...
            <div className="w-full">
              <button className="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full w-full hover:opacity-50 hover:shadow-lg transisiton duration-500">
                Kirim
              </button>
            </div>
          </div>
